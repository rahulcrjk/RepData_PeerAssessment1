...
1. The mean of total number of steps is **`r mean(data$steps,na.rm = TRUE)`.**

2. The median of total number of steps is **`r median(data$steps,na.rm = TRUE)`.**
...
1. The mean of total number of steps is **`r mean(newData$steps,na.rm = TRUE)`.**

2. The median of total number of steps is **`r median(newData$steps,na.rm = TRUE)`.**
